...
---
> **_NOTE:_** advanced users may be able to <a href="https://webos-internals.org/wiki/Tutorials_Linux_Emulator_Networking_Proxy_Firewall" target="_blank">manually setup a proxy following these instructions</a>.
...
Preware needs to be compiled differently for the emulator. The required <a href="http://www.webosarchive.org/activation">i686 build can be found here</a>.