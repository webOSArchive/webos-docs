...
var STEP5_WOSQI_NODE = {
  ...
  info: "<ul>" +
    ...
    "<li>webOS 1.x devices can open <a href='http://appcatalog.webosarchive.org'>appcatalog.webosarchive.org</a> in the built-in browser and/or use Preware.</li>" +
    "</ul>",
  options: [
    {
  ...
  topics: [
    {
      ...
      content: "<p>More and more websites are moving to newer encryption over HTTPS as the only way in. On webOS 2.2.4 and above, the <a href='#' onclick='wosaGoto(6); return false;'>Modern TLS Updates</a> solve this outright; on older devices you're more limited. On TouchPad, make sure you install the Atlas browser from Preware!<br/>Here are some other things you can still do in the browsers, or the equivalent apps:</p>" +
    ...
    },
    {
      ...
      content: "<img src='images/angrybirds.png' align='right' style='padding-left: 8px'>" +
        ...
        "<p><strong>Read a Book:</strong> the TouchPad makes a great reading device. <a href='https://appcatalog.webosarchive.org/app/PapyruseReader' target='_blank'>Papyrus eReader</a> is a classy take on DRM-free ePub reading, derived from the Kindle app and an older indie project, and available on Touchpad <i>and</i> modern devices as a <a href='https://papyrus.wosa.link' target='_blank'>Progressive Web App (PWA)</a>.</p>" +
    ...
    },
    {
      ...
      content: "<img src='images/patch.png' align='right' width='64' style='width:64px; padding-right: 18px'>" +
        "<p>webOS was an extremely customizable operating system, with community-created patches for a wide variety of modifications. Most patches can still be found in Preware and should be installed from there, since they were created by contemporaneous developers.</p>" +
        ...
        "<p><strong>Hardware mods</strong> (advanced, requires micro-soldering): community member Alan Morford has guides to <a href='https://www.webosarchive.org/pivot/2024/09/25/guide-converting-the-touchpads-micro-usb-port-to-usb-c/'>converting the TouchPad's micro-USB port to USB-C</a> and <a href='https://www.webosarchive.org/pivot/2024/12/05/guide-create-an-original-barrel-charging-wire-for-your-hp-touchpad/'>building a warning-free charging cable</a>.</p>"
    },
    {
      label: "Shell Access",
